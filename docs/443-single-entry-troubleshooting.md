...
主菜单 [19 443 单入口管理中心] -> [14 修改 443 共享参数]
主菜单 [19 443 单入口管理中心] -> [11 443 链路体检]
```
...
```text
主菜单 [19 443 单入口管理中心] -> [14 修改 443 共享参数] -> [5 重新应用当前保存的配置]
主菜单 [19 443 单入口管理中心] -> [11 443 链路体检]
```
...
```text
主菜单 [19 443 单入口管理中心] -> [14 修改 443 共享参数] -> [1 修改面板/订阅端口与路径]
主菜单 [19 443 单入口管理中心] -> [14 修改 443 共享参数]
主菜单 [19 443 单入口管理中心] -> [6 重新应用当前入口模式]
主菜单 [19 443 单入口管理中心] -> [11 443 链路体检]
```
...
- 启动或重启 3x-ui / x-ui。
- 在 `主菜单 [19 443 单入口管理中心] -> [14 修改 443 共享参数]` 修正后端监听地址和端口。
- 重新应用配置并体检。
...
```text
主菜单 [19 443 单入口管理中心] -> [15 订阅链接 / External Proxy 提示]
主菜单 [19 443 单入口管理中心] -> [14 修改 443 共享参数]
```
