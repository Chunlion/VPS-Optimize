...
const zhTheme = {
  ...
  nav: [
    ...
    { text: '快速开始', link: '/quick-start' },
    {
      ...
      items: [
        { text: '文档首页', link: '/' },
        { text: '443 单入口', link: '/docs/443-single-entry' },
        { text: '3x-ui + REALITY + 443', link: '/tutorials/01-3x-ui-reality-443' },
  ...
  sidebar: {
    '/': [
      ...
      },
      {
        ...
        items: [
          { text: '443 单入口', link: '/docs/443-single-entry' },
          { text: 'TCP Peek 引擎', link: '/docs/443-tcp-peek-engine' },
      ...
      },
      {
        text: '维护与排错',
        items: [
          { text: '443 排错/恢复', link: '/docs/443-single-entry-troubleshooting' },
          { text: '安全与回滚', link: '/docs/security-rollback' },
  ...
  nav: [
    ...
    { text: 'Quick Start', link: '/en/quick-start' },
    {
      ...
      items: [
        ...
        { text: 'Shared Port 443', link: '/en/docs/443-single-entry' },
        { text: '3x-ui + REALITY + 443', link: '/en/tutorials/01-3x-ui-reality-443' },
  ...
  sidebar: {
    '/en/': [
      ...
      },
      {
        ...
        items: [
          { text: 'Shared Port 443', link: '/en/docs/443-single-entry' },
          { text: 'TCP Peek Engine', link: '/en/docs/443-tcp-peek-engine' },
      ...
      },
      {
        text: 'Maintenance',
        items: [
          { text: 'Port 443 Troubleshooting', link: '/en/docs/443-single-entry-troubleshooting' },
          { text: 'Security and Rollback', link: '/en/docs/security-rollback' },
  ...
  nav: [
    ...
    { text: 'Быстрый старт', link: '/ru/quick-start' },
    {
      ...
      items: [
        ...
        { text: 'Единая точка входа 443', link: '/ru/docs/443-single-entry' },
        { text: '3x-ui + REALITY + 443', link: '/ru/tutorials/01-3x-ui-reality-443' },
  ...
  sidebar: {
    '/ru/': [
      ...
      },
      {
        ...
        items: [
          { text: 'Единая точка входа 443', link: '/ru/docs/443-single-entry' },
          { text: 'Движок TCP Peek', link: '/ru/docs/443-tcp-peek-engine' },
      ...
      },
      {
        text: 'Обслуживание',
        items: [
          { text: 'Диагностика порта 443', link: '/ru/docs/443-single-entry-troubleshooting' },
          { text: 'Безопасность и откат', link: '/ru/docs/security-rollback' },
