...
| 工具 | 菜单路径 | 适合场景 |
|---|---|---|
| SublinkPro | `主菜单 [5 面板、节点与订阅工具] -> [5 管理 SublinkPro]` | 订阅转换、聚合、管理 |
| 妙妙屋订阅管理 | `主菜单 [5 面板、节点与订阅工具] -> [6 管理 妙妙屋订阅管理]` | 图形化订阅管理 |
| Sub-Store | `主菜单 [5 面板、节点与订阅工具] -> [7 管理 Sub-Store]` | 高级订阅处理和脚本化 |
| Dockge | `主菜单 [5 面板、节点与订阅工具] -> [8 管理 Dockge]` | 管理多个 Compose 项目 |
